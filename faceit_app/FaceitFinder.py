...
def generateOutput():
    ...
    lbl_name = Label(root,text='Name:',font=('PANTONE',12,'bold'),bg='#161616',fg='#EBEFF3')
    lbl_name.grid(row=4,column=1,sticky='w')

    lbl_elo = Label(root,text='Elo:',font=('PANTONE',12,'bold'),bg='#161616',fg='#EBEFF3')
    lbl_elo.grid(row=4,column=2,sticky='w')
